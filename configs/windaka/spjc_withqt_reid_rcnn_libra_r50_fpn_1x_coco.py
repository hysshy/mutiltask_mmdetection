model = dict(
    type='TwoStageDetector_SPJC_FaceQt_FaceKp_Reid',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/chase/shy/dataset/reidData/reid0902.json",
        img_prefix="/home/chase/shy/dataset/reidData/images/",
...
resume_from = ''
workflow = [('train', 1)]
work_dir = "/home/chase/shy/TrainImgs/reidData/reidModel1"
