model = dict(
    type='TwoStageDetector_HalfpersonFace_Detect_Qt_Kp',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/home/chase/shy/TrainImgs/halfPerson-face/half-face.json',
        img_prefix='/home/chase/shy/TrainImgs/halfPerson-face',
...
resume_from = ''
workflow = [('train', 1)]
work_dir = "/home/chase/shy/TrainImgs/halfPerson-face/model3"
