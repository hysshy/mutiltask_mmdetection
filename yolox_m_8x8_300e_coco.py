...
model = dict(
    ...
    neck=dict(
        ...
        out_channels=192,
        num_csp_blocks=2),
    bbox_head= dict(type='YOLOXHead', num_classes=9, in_channels=192, feat_channels=192),
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='CocoDataset',
            ann_file='/home/chase/shy/dataset/hyfactor/hyfactor0109_train',
            img_prefix='',
            pipeline=[
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/home/chase/shy/dataset/hyfactor/hyfactor0109_test.json',
        img_prefix='',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
evaluation = dict(
    save_best='auto', interval=10, dynamic_intervals=[(max_epochs-num_last_epochs, 1)], metric='bbox')
work_dir = './work_dirs/yolox_m_8x8_300e_coco2_1111'
auto_resume = False
gpu_ids = [0,1]
